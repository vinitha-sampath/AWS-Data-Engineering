...
create or replace storage integration s3_int
  ...
  storage_provider = s3
  enabled = true
  storage_aws_role_arn = 'arn:aws:iam::905130072979:role/AWS2Snowflake'
  storage_allowed_locations = ('s3://de-project-fetch-weatherapi/snowflake/');
...
create or replace stage ext_csv_stage
  URL = 's3://de-project-fetch-weatherapi/snowflake/'
